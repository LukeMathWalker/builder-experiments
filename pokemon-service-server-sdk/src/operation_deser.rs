...
pub async fn parse_check_health_request<B>(
        ...
        From<<B as aws_smithy_http_server::body::HttpBody>::Error>,
{
    Ok({
        ...
        aws_smithy_http_server::protocols::content_type_header_empty_body_no_modeled_input(
            request,
        )?;
        input.build()?
    })
...
#[allow(clippy::unnecessary_wraps)]
pub async fn parse_do_nothing_request<B>(
    #[allow(unused_variables)] request: &mut aws_smithy_http_server::request::RequestParts<B>,
) -> std::result::Result<
...
#[allow(clippy::unnecessary_wraps)]
pub async fn parse_capture_pokemon_request<B>(
    #[allow(unused_variables)] request: &mut aws_smithy_http_server::request::RequestParts<B>,
) -> std::result::Result<
        ...
        From<<B as aws_smithy_http_server::body::HttpBody>::Error>,
{
    Ok({
        ...
        input = input.set_events({
            let body = request
                .take_body()
                .ok_or(aws_smithy_http_server::rejection::RequestRejection::BodyAlreadyExtracted)?;
            Some(
                crate::http_serde::deser_payload_capture_pokemon_capture_pokemon_input_events(
        ...
        let (input_string, (_, m1)) = nom::sequence::tuple::<_, _, nom::error::Error<&str>, _>((
            nom::sequence::preceded(
                nom::bytes::complete::tag("/"),
                nom::bytes::complete::tag::<_, _, nom::error::Error<&str>>("capture-pokemon-event"),
            ),
            nom::sequence::preceded(
                nom::bytes::complete::tag("/"),
                nom::branch::alt::<_, _, nom::error::Error<&str>, _>((
        ...
        debug_assert_eq!("", input_string);
        input = input.set_region(Some(
            crate::operation_deser::parse_str_capture_pokemon_input_region(m1)?,
        ));
        input.build()?
    })
}
...
#[allow(clippy::unnecessary_wraps)]
pub async fn parse_get_storage_request<B>(
    #[allow(unused_variables)] request: &mut aws_smithy_http_server::request::RequestParts<B>,
) -> std::result::Result<
        ...
        From<<B as aws_smithy_http_server::body::HttpBody>::Error>,
{
    Ok({
        ...
        input = input.set_passcode(
            crate::http_serde::deser_header_get_storage_get_storage_input_passcode(
                request.headers().ok_or(
                    aws_smithy_http_server::rejection::RequestRejection::HeadersAlreadyExtracted,
                )?,
            )?,
        );
        let input_string = request.uri().path();
        ...
        debug_assert_eq!("", input_string);
        input = input.set_user(Some(
            crate::operation_deser::parse_str_get_storage_input_user(m1)?,
        ));
        input.build()?
    })
}
...
pub fn parse_str_capture_pokemon_input_region(
    value: &str,
) -> std::result::Result<std::string::String, aws_smithy_http_server::rejection::RequestRejection> {
    let value = percent_encoding::percent_decode_str(value).decode_utf8()?;
    let value = std::string::String::try_from(value.as_ref())?;
...
pub fn parse_str_get_storage_input_user(
    value: &str,
) -> std::result::Result<std::string::String, aws_smithy_http_server::rejection::RequestRejection> {
    let value = percent_encoding::percent_decode_str(value).decode_utf8()?;
    let value = std::string::String::try_from(value.as_ref())?;
