...
pub struct FlavorText {
    ...
    #[doc(hidden)]
    pub flavor_text: std::option::Option<std::string::String>,
...
impl FlavorText {
    /// The localized flavor text for an API resource in a specific language.
    pub fn flavor_text(&self) -> std::option::Option<&str> {
        self.flavor_text.as_deref()
    }
    /// The language this name is in.
...
pub mod flavor_text {
    ...
    impl Builder {
        ...
        pub fn build(self) -> crate::model::FlavorText {
