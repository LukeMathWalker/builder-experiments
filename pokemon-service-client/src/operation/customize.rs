...
#[derive(Debug)]
pub struct CustomizableOperation<O, Retry, C, M, R> {
    pub(crate) handle: Arc<Handle<C, M, R>>,
    pub(crate) operation: Operation<O, Retry>,
}

impl<O, Retry, C, M, R> CustomizableOperation<O, Retry, C, M, R>
where
    ...
    R: aws_smithy_client::retry::NewRequestPolicy,
{
    ...
    where
        ...
        <R as aws_smithy_client::retry::NewRequestPolicy>::Policy:
            aws_smithy_client::bounds::SmithyRetryPolicy<O, T, E, Retry> + Clone,
    {
